    ...
    <BlankLayout>
      ...
      <Card sx={{ zIndex: 1 }}>
        <CardContent sx={{ pl:6, paddingRight:6, pt:7, pb:7 }}>
          <Box sx={{ mb: 4 }}>
            <Typography variant='h4' sx={{ fontWeight: 600, marginBottom: 1.5 }}> Welcome to {themeConfig.templateName}! 👋🏻 </Typography>
            <Typography variant='body2'>Please sign-in to your account and start the tracking</Typography>
          </Box>
          <form noValidate autoComplete='off' onSubmit={e => e.preventDefault()}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'center', marginBottom: 3 }}>
              ...
              <Typography variant='body2'>
                <Link to='/'><LinkStyled>Create an account</LinkStyled></Link>
              </Typography>
            </Box>
          </form>
        </CardContent>
